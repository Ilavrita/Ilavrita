...
The two files beside this one are the FHIR R4 specification's own definition
...
```bash
curl -sSo profiles-resources.json https://hl7.org/fhir/R4/profiles-resources.json
curl -sSo profiles-types.json https://hl7.org/fhir/R4/profiles-types.json
shasum -a 256 profiles-resources.json profiles-types.json
gzip -9 profiles-resources.json profiles-types.json
```
