-- The sessions table as it stood before this server could record what a SMART
-- app was granted. Every column and check is the release's own; the only
-- difference from the current declaration is what is not here.
