...
| [Implementation guides](profiles.md) | Validating against a guide's profiles |
...
| [Design specifications](design) | What each subsystem must do, in rules a test can check |
| [Product requirements](prd/ilavrita-prd-v0.1.docx) | The v0.1 product boundary |

Ilavrita is a scaffold. Where a document describes behaviour that is not
